...
wget --no-check-certificate https://raw.githubusercontent.com/giGurylsPro/firend-best/master/frirandom.sh
...
wget --no-check-certificate https://raw.githubusercontent.com/giGurylsPro/firend-best/master/fripartner.sh
...
rm -r src
cd /root/3proxy/
wget --no-check-certificate https://github.com/giGurylsPro/firend-best/raw/master/frirarman.zip
unzip frirarman.zip
chmod +x bin/
...
wget --no-check-certificate https://raw.githubusercontent.com/giGurylsPro/firend-best/master/frirota.sh
...
wget --no-check-certificate https://raw.githubusercontent.com/giGurylsPro/firend-best/master/fritestt.sh
